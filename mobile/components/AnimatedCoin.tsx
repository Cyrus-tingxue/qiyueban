            ...
            <Svg viewBox="0 0 100 180" >
                ...
                <G>
                    ...
                    <G transform="translate(0, 0)">
                        ...
                        <Circle cx="50" cy="105" r="38" fill="url(#bronzeDark)" stroke="#050201" strokeWidth="3" />
                        ...
                        {/* 内方孔 (22x22) */}
                        <Rect x="39" y="94" width="22" height="22" fill="#000" />
                        ...
                        <G fill="url(#textGlow)" fontFamily="'Zhi Mang Xing', 'Ma Shan Zheng', 'Kaiti', serif" fontSize="16" fontWeight="900">
                            {/* 上 */}
                            <SvgText x="50" y="85" textAnchor="middle" transform="translate(0, -6)">半</SvgText>
                            {/* 下 */}
                            <SvgText x="50" y="136" textAnchor="middle" transform="translate(0, -11)">月</SvgText>
                            {/* 右 */}
                            <SvgText x="82" y="110" textAnchor="middle" transform="translate(4, -8)">通</SvgText>
                            {/* 左 */}
                            <SvgText x="18" y="110" textAnchor="middle" transform="translate(-4, -8)">寶</SvgText>
                        </G>
